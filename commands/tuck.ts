...
module.exports = async (client, context) => {
  ...
  context.args.shift()
  const message = context.args[0] ? context.args.join(' ') : await utils.bestEmote(context.channel, ['catKISS', 'KissAWeeb', 'FumoKiss', 'FumoTuck', 'SoCute', 'HUGGIES', 'Tuckacutie', 'CatAHomie', '🛌', '😴']) + ' 💝'
