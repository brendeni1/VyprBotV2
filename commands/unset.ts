...
module.exports = async (client, context) => {
  ...
  await fs.writeJson(`suggestions/active/${id}.json`, { user: context.user, id: id, channel: suggestionDetails.channel, date: suggestionDetails.date, dateDismissed: utils.addHours(new Date(), -5).toISOString(), suggestion: suggestionDetails.suggestion })
