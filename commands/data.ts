...
module.exports = async (client, context) => {
  ...
  if (context.args[0] == 'get') {
    ...
    if (data == null) { return { success: true, reply: `There is no data with the name "${context.args[1]}".` } }
  ...
  if (context.args[0] == 'list') {
    ...
    if (data[0] == null) { return { success: true, reply: `There is no data with the prefix "${context.args[1]}".` } }
    console.log('-----------'); console.log(); console.log(data); console.log(); console.log('-----------')
